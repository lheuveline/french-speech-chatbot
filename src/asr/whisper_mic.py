...
# Just a rewrite of https://github.com/mallorbc/whisper_mic/blob/main/whisper_mic/whisper_mic.py to remove pyinput dep and enable listening from ssh
# Should have its own fork
# 
#
#
